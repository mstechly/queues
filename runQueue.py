...
if __name__ == '__main__':
    ...
    parser.add_argument('-c', action="store", dest="cockroachSimulation", type=int, help='Is it a simulation for the cockroaches.', default=0)
